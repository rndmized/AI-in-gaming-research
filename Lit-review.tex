...
\title{Practical Applications of AI and Machine learning in different areas within Game Development Industry and multiple implementation approaches.}
%
%
...
\IEEEPARstart{W}{e} have come a long way since video games were first created back in the 1950's. The first of which was 'Tennis for Two', introduced on October 18, 1958, at Brookhaven National Laboratory, An electronic tennis game that would become the father of modern video games[1]. But what is essentially a video game? As defined by [2] video game [noun] "A game played by electronically manipulating images produced by a computer program on a monitor or other display". Born in laboratories the first video games were developed by scientists putting the computational frames on Universities to the test. 
